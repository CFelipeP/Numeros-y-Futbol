...
$validDivisions = [
    ...
    'reservas' => ['partidos_reservas', 'tabla_posiciones_reservas', 'partidos_jugados = 0, ganados = 0, empatados = 0, perdidos = 0, goles_favor = 0, goles_contra = 0, puntos = 0'],
    'burgerking' => ['partidos_burgerking', 'tabla_posiciones_burgerking', 'partidos_jugados = 0, ganados = 0, empatados = 0, perdidos = 0, goles_favor = 0, goles_contra = 0, puntos = 0'],
];
