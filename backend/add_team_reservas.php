...
$stmt = $conn->prepare("INSERT INTO equipos_reservas (nombre, ciudad, estadio, logo) VALUES (?, ?, ?, ?)");
$stmt->execute([$nombre, $ciudad, $estadio, $ruta]);

$id = $conn->lastInsertId();

$stmt2 = $conn->prepare("INSERT INTO tabla_posiciones_reservas (equipo_id) VALUES (?)");
$stmt2->execute([$id]);
