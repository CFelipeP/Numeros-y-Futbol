...
const Footer = () => (
    <footer className="footer" id="driver-footer">
        <div className="container footer-inner">
            ...
            <div className="footer-bottom"><p>&copy; {new Date().getFullYear()} Números y Fútbol. Todos los derechos reservados.</p><div className="footer-links"><a href="#">Privacidad</a><a href="#">Términos</a><a href="#">Contacto</a></div></div>
        </div>
    </footer>
);
