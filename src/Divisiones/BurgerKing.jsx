        ...
        {activeTab === "clasificacion" && !expandedTeam && (
          <div className="dashboard-grid">
            <div className="pd-sidebar">
              ...
              {/* ÚLTIMOS RESULTADOS */}
              <div className="glass-card" style={{ padding: "1.8rem" }}><div className="section-subtitle" style={{ marginTop: 0, display: "flex", alignItems: "center", gap: "0.5rem" }}><span style={{ width: 8, height: 8, borderRadius: "50%", background: "#f59e0b", boxShadow: "0 0 8px #f59e0b", display: "inline-block" }} />Últimos Resultados de la jornada</div>
                {jornadas.length > 0 && (
