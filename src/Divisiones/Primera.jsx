...
// Construir URL completa para logos relativos
const logoUrl = (path) => {
  if (!path) return "";
...
// Fetch seguro que detecta respuestas HTML
const safeFetch = async (url) => {
  const res = await fetch(url);
  const text = await res.text();
  // Si empieza con < es HTML (error PHP, 404, etc)
...
export default function PrimeraDivision() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      .then(([tablaData, matchData, equiposData]) => {
        setTabla(Array.isArray(tablaData) ? tablaData : []);
        // matchData puede ser objeto vacío {} si no hay partidos
        setMatch((matchData && Object.keys(matchData).length > 0) ? matchData : null);
        ...
        <section className="table-section" style={{ minHeight: "60vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
          <div style={{ textAlign: "center" }}>
            <div style={{
              ...
              border: "3px solid rgba(255,0,77,0.2)", borderTopColor: "#ff004d",
              animation: "spin 1s linear infinite", margin: "0 auto 1rem"
            }} />
            <p style={{ color: "var(--color-text-muted)", fontFamily: "var(--font-heading)", fontWeight: 600, letterSpacing: "1px" }}>
              CARGANDO DATOS...
            </p>
        ...
        <section className="table-section" style={{ minHeight: "60vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
          <div className="glass-card" style={{
            ...
            <div style={{
              ...
              fontSize: "0.8rem", color: "var(--color-text-muted)", textAlign: "left",
              fontFamily: "monospace", marginBottom: "1.5rem", wordBreak: "break-all"
            }}>
            ...
            <button
              ...
              style={{
                background: "linear-gradient(90deg, var(--color-accent), #ff3366)",
    ...
    <>
      ...
      <section className="table-section" style={{ paddingBottom: 0 }}>
        ...
        <div className="container" style={{ marginBottom: "1.5rem" }}>
          ...
          <p style={{ color: "var(--color-text-muted)", fontSize: "1rem", margin: 0, paddingLeft: "1.8rem" }}>
            Clasificación general, equipos y partido destacado de la Liga Mayor
          </p>
        </div>
        ...
        <div className="container" style={{ marginBottom: "2rem" }}>
          <div style={{
            ...
            borderRadius: "12px", padding: "4px", border: "1px solid rgba(255,255,255,0.05)"
          }}>
            {[
              ...
              <button
                ...
                style={{
                  ...
                  fontFamily: "var(--font-heading)", fontWeight: 700,
                  fontSize: "0.85rem", letterSpacing: "0.5px", textTransform: "uppercase",
                  background: activeTab === tab.key
                    ? "linear-gradient(135deg, rgba(255,0,77,0.2), rgba(255,0,77,0.08))"
                    : "transparent",
                  color: activeTab === tab.key ? "var(--color-accent)" : "var(--color-text-muted)",
                  boxShadow: activeTab === tab.key ? "0 0 15px rgba(255,0,77,0.15)" : "none",
          ...
          <div className="dashboard-grid">
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
              ...
              <div className="glass-card" style={{ padding: "1.8rem" }}>
                ...
                {match ? (
                  <div className="compact-match-card" style={{
                    background: "linear-gradient(135deg, rgba(255,0,77,0.06) 0%, rgba(30,41,59,0.5) 100%)",
                    border: "1px solid rgba(255,0,77,0.12)", padding: "1.5rem 1.2rem"
                  }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1.2rem" }}>
                      ...
                      <span className="live-badge-small" style={{
                        background: getMatchStatus(match.estado).variant === "live" ? "var(--color-loss)"
                          : getMatchStatus(match.estado).variant === "finished" ? "var(--color-success)" : "var(--color-draw)",
                        animation: getMatchStatus(match.estado).variant === "live" ? "pulse 2s infinite" : "none"
                      }}>
                    ...
                    {tabla.map((team, index) => {
                      ...
                      return (
                        <tr key={team.id} style={{
                          borderLeft: badge ? `3px solid ${badge.color}` : isBottom ? "3px solid rgba(239,68,68,0.4)" : "3px solid transparent",
                ...
                {equipos.map((equipo) => {
                  ...
                  return (
                    <div
                      ...
                      style={{
                        padding: 0, overflow: "hidden", transition: "all 0.3s ease", cursor: "default",
                        borderLeft: badge ? `3px solid ${badge.color}` : "3px solid transparent"
                      }}
                      onMouseEnter={(e) => {
                        e.currentTarget.style.transform = "translateY(-6px)";
                        e.currentTarget.style.boxShadow = "0 15px 40px rgba(0,0,0,0.4), 0 0 20px rgba(255,0,77,0.1)";
                        e.currentTarget.style.borderColor = "rgba(255,0,77,0.3)";
                        if (badge) e.currentTarget.style.borderLeftColor = badge.color;
                      }}
                      onMouseLeave={(e) => {
                        e.currentTarget.style.transform = "translateY(0)";
                        e.currentTarget.style.boxShadow = "var(--shadow-card)";
                        e.currentTarget.style.borderColor = "rgba(255,255,255,0.05)";
                        e.currentTarget.style.borderLeftColor = badge ? badge.color : "transparent";
                      }}
                    >
                      <div style={{
                        height: "6px",
                        background: badge
                          ? `linear-gradient(90deg, ${badge.color}, transparent)`
                      ...
                      <div style={{ padding: "1.5rem" }}>
                        <div style={{ display: "flex", alignItems: "center", gap: "1rem", marginBottom: "1.2rem" }}>
                          <div style={{
                            ...
                            flexShrink: 0,
                            border: badge ? `2px solid ${badge.color}40` : "2px solid rgba(255,255,255,0.08)"
                          }}>
                            <img src={logoUrl(equipo.logo)} alt={equipo.nombre} style={{ width: "100%", height: "100%", objectFit: "contain" }} />
                          </div>
                          <div style={{ flex: 1, minWidth: 0 }}>
                            <h4 style={{ fontFamily: "var(--font-heading)", fontSize: "1.1rem", fontWeight: 800, margin: "0 0 0.2rem 0", color: "var(--color-white)", lineHeight: 1.2, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                              {equipo.nombre}
                            </h4>
                            {badge && (
                              <span style={{ fontSize: "0.65rem", fontWeight: 700, textTransform: "uppercase", letterSpacing: "1px", color: badge.color, background: badge.bg, padding: "0.15rem 0.5rem", borderRadius: "4px" }}>
                                Pos. {pos + 1}
                              </span>
                            )}
                          </div>
