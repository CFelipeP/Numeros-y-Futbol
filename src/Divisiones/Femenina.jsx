...
export default function Femenina() {
  ...
  useEffect(() => {
    ...
    Promise.allSettled([safeFetch(`${API_BASE}get_tabla_femenina.php`), safeFetch(`${API_BASE}get_featured_match_femenina.php?t=${Date.now()}`), safeFetch(`${API_BASE}get_teams_femenina.php`), safeFetch(`${API_BASE}get_sidebar_matches_femenina.php`)]).then(r => {
