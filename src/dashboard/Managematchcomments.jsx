          ...
          {SIDEBAR_ITEMS.map((item,idx)=>{
            if(item.type==="dropdown") return (
              <li key={idx}>
                ...
                <ul style={{maxHeight:teamsOpen?"400px":"0",opacity:teamsOpen?"1":"0",overflow:"hidden",transition:"max-height .3s,opacity .2s",listStyle:"none",padding:teamsOpen?"2px 0 4px":"0",margin:0}}>
